...
static inline void hal_radio_enable_on_tick_ppi_config_and_enable(uint8_t trx)
{
    ...
    nrf_ppi_channels_disable(
        NRF_PPI,
        trx ? BIT(HAL_RADIO_ENABLE_RX_ON_TICK_PPI) : BIT(HAL_RADIO_ENABLE_TX_ON_TICK_PPI));
    nrf_ppi_channels_enable(
        NRF_PPI,
        trx ? BIT(HAL_RADIO_ENABLE_TX_ON_TICK_PPI) : BIT(HAL_RADIO_ENABLE_RX_ON_TICK_PPI));
}
...
static inline void hal_radio_enable_on_tick_ppi_config_and_enable(uint8_t trx)
{
    uint32_t event_address = (trx ? (uint32_t) & (NRF_RADIO->TASKS_TXEN) : (uint32_t) & (NRF_RADIO->TASKS_RXEN));
...
static inline void hal_palna_ppi_setup(void)
{
    nrf_ppi_channel_endpoint_setup(
        ...
        (uint32_t) & (NRF_GPIOTE->TASKS_OUT[CONFIG_BT_CTLR_PA_LNA_GPIOTE_CHAN]));
    nrf_ppi_channel_endpoint_setup(
        NRF_PPI,
...
#define HAL_RADIO_ENABLE_ON_TICK_PPI_EVT                                                                     \
    (((HAL_RADIO_ENABLE_ON_TICK_PPI << TIMER_PUBLISH_COMPARE_CHIDX_Pos) & TIMER_PUBLISH_COMPARE_CHIDX_Msk) | \
     ((TIMER_PUBLISH_COMPARE_EN_Enabled << TIMER_PUBLISH_COMPARE_EN_Pos) & TIMER_PUBLISH_COMPARE_EN_Msk))
...
#define HAL_RADIO_ENABLE_ON_TICK_PPI_TASK_TX_SET                                                           \
    (((HAL_RADIO_ENABLE_ON_TICK_PPI << RADIO_SUBSCRIBE_TXEN_CHIDX_Pos) & RADIO_SUBSCRIBE_TXEN_CHIDX_Msk) | \
     ((RADIO_SUBSCRIBE_TXEN_EN_Enabled << RADIO_SUBSCRIBE_TXEN_EN_Pos) & RADIO_SUBSCRIBE_TXEN_EN_Msk))
#define HAL_RADIO_ENABLE_ON_TICK_PPI_TASK_RX_SET                                                           \
    (((HAL_RADIO_ENABLE_ON_TICK_PPI << RADIO_SUBSCRIBE_RXEN_CHIDX_Pos) & RADIO_SUBSCRIBE_RXEN_CHIDX_Msk) | \
     ((RADIO_SUBSCRIBE_RXEN_EN_Enabled << RADIO_SUBSCRIBE_RXEN_EN_Pos) & RADIO_SUBSCRIBE_RXEN_EN_Msk))
...
#define HAL_RADIO_RECV_TIMEOUT_CANCEL_PPI_EVT                                                                     \
    (((HAL_RADIO_RECV_TIMEOUT_CANCEL_PPI << RADIO_PUBLISH_ADDRESS_CHIDX_Pos) & RADIO_PUBLISH_ADDRESS_CHIDX_Msk) | \
     ((RADIO_PUBLISH_ADDRESS_EN_Enabled << RADIO_PUBLISH_ADDRESS_EN_Pos) & RADIO_PUBLISH_ADDRESS_EN_Msk))
...
#define HAL_RADIO_RECV_TIMEOUT_CANCEL_PPI_TASK                                                                        \
    (((HAL_RADIO_RECV_TIMEOUT_CANCEL_PPI << TIMER_SUBSCRIBE_CAPTURE_CHIDX_Pos) & TIMER_SUBSCRIBE_CAPTURE_CHIDX_Msk) | \
     ((TIMER_SUBSCRIBE_CAPTURE_EN_Enabled << TIMER_SUBSCRIBE_CAPTURE_EN_Pos) & TIMER_SUBSCRIBE_CAPTURE_EN_Msk))
...
#define HAL_RADIO_DISABLE_ON_HCTO_PPI_EVT                                                                     \
    (((HAL_RADIO_DISABLE_ON_HCTO_PPI << TIMER_PUBLISH_COMPARE_CHIDX_Pos) & TIMER_PUBLISH_COMPARE_CHIDX_Msk) | \
     ((TIMER_PUBLISH_COMPARE_EN_Enabled << TIMER_PUBLISH_COMPARE_EN_Pos) & TIMER_PUBLISH_COMPARE_EN_Msk))
#define HAL_RADIO_DISABLE_ON_HCTO_PPI_REGISTER_TASK \
    NRF_RADIO->SUBSCRIBE_DISABLE
#define HAL_RADIO_DISABLE_ON_HCTO_PPI_TASK                                                                        \
    (((HAL_RADIO_DISABLE_ON_HCTO_PPI << RADIO_SUBSCRIBE_DISABLE_CHIDX_Pos) & RADIO_SUBSCRIBE_DISABLE_CHIDX_Msk) | \
     ((RADIO_SUBSCRIBE_DISABLE_EN_Enabled << RADIO_SUBSCRIBE_DISABLE_EN_Pos) & RADIO_SUBSCRIBE_DISABLE_EN_Msk))
...
#define HAL_RADIO_END_TIME_CAPTURE_PPI_EVT                                                             \
    (((HAL_RADIO_END_TIME_CAPTURE_PPI << RADIO_PUBLISH_END_CHIDX_Pos) & RADIO_PUBLISH_END_CHIDX_Msk) | \
     ((RADIO_PUBLISH_END_EN_Enabled << RADIO_PUBLISH_END_EN_Pos) & RADIO_PUBLISH_END_EN_Msk))
...
#define HAL_RADIO_END_TIME_CAPTURE_PPI_TASK                                                                        \
    (((HAL_RADIO_END_TIME_CAPTURE_PPI << TIMER_SUBSCRIBE_CAPTURE_CHIDX_Pos) & TIMER_SUBSCRIBE_CAPTURE_CHIDX_Msk) | \
     ((TIMER_SUBSCRIBE_CAPTURE_EN_Enabled << TIMER_SUBSCRIBE_CAPTURE_EN_Pos) & TIMER_SUBSCRIBE_CAPTURE_EN_Msk))
...
#define HAL_EVENT_TIMER_START_PPI_EVT                                                                 \
    (((HAL_EVENT_TIMER_START_PPI << RTC_PUBLISH_COMPARE_CHIDX_Pos) & RTC_PUBLISH_COMPARE_CHIDX_Msk) | \
     ((RTC_PUBLISH_COMPARE_EN_Enabled << RTC_PUBLISH_COMPARE_EN_Pos) & RTC_PUBLISH_COMPARE_EN_Msk))
#define HAL_EVENT_TIMER_START_PPI_REGISTER_TASK \
    EVENT_TIMER->SUBSCRIBE_START
#define HAL_EVENT_TIMER_START_PPI_TASK                                                                    \
    (((HAL_EVENT_TIMER_START_PPI << TIMER_SUBSCRIBE_START_CHIDX_Pos) & TIMER_SUBSCRIBE_START_CHIDX_Msk) | \
     ((TIMER_SUBSCRIBE_START_EN_Enabled << TIMER_SUBSCRIBE_START_EN_Pos) & TIMER_SUBSCRIBE_START_EN_Msk))
...
#define HAL_RADIO_READY_TIME_CAPTURE_PPI_EVT                                                                 \
    (((HAL_RADIO_READY_TIME_CAPTURE_PPI << RADIO_PUBLISH_READY_CHIDX_Pos) & RADIO_PUBLISH_READY_CHIDX_Msk) | \
     ((RADIO_PUBLISH_READY_EN_Enabled << RADIO_PUBLISH_READY_EN_Pos) & RADIO_PUBLISH_READY_EN_Msk))
...
#define HAL_RADIO_READY_TIME_CAPTURE_PPI_TASK                                                                        \
    (((HAL_RADIO_READY_TIME_CAPTURE_PPI << TIMER_SUBSCRIBE_CAPTURE_CHIDX_Pos) & TIMER_SUBSCRIBE_CAPTURE_CHIDX_Msk) | \
     ((TIMER_SUBSCRIBE_CAPTURE_EN_Enabled << TIMER_SUBSCRIBE_CAPTURE_EN_Pos) & TIMER_SUBSCRIBE_CAPTURE_EN_Msk))
...
#define HAL_TRIGGER_CRYPT_PPI_EVT                                                                     \
    (((HAL_TRIGGER_CRYPT_PPI << RADIO_PUBLISH_ADDRESS_CHIDX_Pos) & RADIO_PUBLISH_ADDRESS_CHIDX_Msk) | \
     ((RADIO_PUBLISH_ADDRESS_EN_Enabled << RADIO_PUBLISH_ADDRESS_EN_Pos) & RADIO_PUBLISH_ADDRESS_EN_Msk))
#define HAL_TRIGGER_CRYPT_PPI_REGISTER_TASK \
    NRF_CCM->SUBSCRIBE_CRYPT
#define HAL_TRIGGER_CRYPT_PPI_TASK                                                                \
    (((HAL_TRIGGER_CRYPT_PPI << CCM_SUBSCRIBE_CRYPT_CHIDX_Pos) & CCM_SUBSCRIBE_CRYPT_CHIDX_Msk) | \
     ((CCM_SUBSCRIBE_CRYPT_EN_Enabled << CCM_SUBSCRIBE_CRYPT_EN_Pos) & CCM_SUBSCRIBE_CRYPT_EN_Msk))
...
#define HAL_TRIGGER_AAR_PPI_EVT                                                                     \
    (((HAL_TRIGGER_AAR_PPI << RADIO_PUBLISH_BCMATCH_CHIDX_Pos) & RADIO_PUBLISH_BCMATCH_CHIDX_Msk) | \
     ((RADIO_PUBLISH_BCMATCH_EN_Enabled << RADIO_PUBLISH_BCMATCH_EN_Pos) & RADIO_PUBLISH_BCMATCH_EN_Msk))
#define HAL_TRIGGER_AAR_PPI_REGISTER_TASK \
    NRF_AAR->SUBSCRIBE_START
#define HAL_TRIGGER_AAR_PPI_TASK                                                                \
    (((HAL_TRIGGER_AAR_PPI << AAR_SUBSCRIBE_START_CHIDX_Pos) & AAR_SUBSCRIBE_START_CHIDX_Msk) | \
     ((AAR_SUBSCRIBE_START_EN_Enabled << AAR_SUBSCRIBE_START_EN_Pos) & AAR_SUBSCRIBE_START_EN_Msk))
...
#define HAL_TRIGGER_RATEOVERRIDE_PPI_EVT                                                                         \
    (((HAL_TRIGGER_RATEOVERRIDE_PPI << RADIO_PUBLISH_RATEBOOST_CHIDX_Pos) & RADIO_PUBLISH_RATEBOOST_CHIDX_Msk) | \
     ((RADIO_PUBLISH_RATEBOOST_EN_Enabled << RADIO_PUBLISH_RATEBOOST_EN_Pos) & RADIO_PUBLISH_RATEBOOST_EN_Msk))
#define HAL_TRIGGER_RATEOVERRIDE_PPI_REGISTER_TASK \
    NRF_CCM->SUBSCRIBE_RATEOVERRIDE
#define HAL_TRIGGER_RATEOVERRIDE_PPI_TASK                                                                              \
    (((HAL_TRIGGER_RATEOVERRIDE_PPI << CCM_SUBSCRIBE_RATEOVERRIDE_CHIDX_Pos) & CCM_SUBSCRIBE_RATEOVERRIDE_CHIDX_Msk) | \
     ((CCM_SUBSCRIBE_RATEOVERRIDE_EN_Enabled << CCM_SUBSCRIBE_RATEOVERRIDE_EN_Pos) & CCM_SUBSCRIBE_RATEOVERRIDE_EN_Msk))
...
#define HAL_SW_SWITCH_TIMER_CLEAR_PPI_EVT                                                             \
    (((HAL_SW_SWITCH_TIMER_CLEAR_PPI << RADIO_PUBLISH_END_CHIDX_Pos) & RADIO_PUBLISH_END_CHIDX_Msk) | \
     ((RADIO_PUBLISH_END_EN_Enabled << RADIO_PUBLISH_END_EN_Pos) & RADIO_PUBLISH_END_EN_Msk))
...
#define HAL_SW_SWITCH_TIMER_CLEAR_PPI_TASK                                                                    \
    (((HAL_SW_SWITCH_TIMER_CLEAR_PPI << TIMER_SUBSCRIBE_CLEAR_CHIDX_Pos) & TIMER_SUBSCRIBE_CLEAR_CHIDX_Msk) | \
...
#define HAL_SW_SWITCH_GROUP_TASK_DISABLE_PPI_EVT(chan)                               \
    (((chan << TIMER_PUBLISH_COMPARE_CHIDX_Pos) & TIMER_PUBLISH_COMPARE_CHIDX_Msk) | \
     ((TIMER_PUBLISH_COMPARE_EN_Enabled << TIMER_PUBLISH_COMPARE_EN_Pos) & TIMER_PUBLISH_COMPARE_EN_Msk))
...
#define HAL_SW_SWITCH_GROUP_TASK_DISABLE_PPI_TASK(chan)                                  \
    (((chan << DPPIC_SUBSCRIBE_CHG_DIS_CHIDX_Pos) & DPPIC_SUBSCRIBE_CHG_DIS_CHIDX_Msk) | \
     ((DPPIC_SUBSCRIBE_CHG_DIS_EN_Enabled << DPPIC_SUBSCRIBE_CHG_DIS_EN_Pos) & DPPIC_SUBSCRIBE_CHG_DIS_EN_Msk))
...
#define HAL_SW_SWITCH_GROUP_TASK_ENABLE_PPI_REGISTER_EVT \
    (NRF_RADIO->PUBLISH_END)
#define HAL_SW_SWITCH_GROUP_TASK_ENABLE_PPI_EVT                                                             \
    (((HAL_SW_SWITCH_GROUP_TASK_ENABLE_PPI << RADIO_PUBLISH_END_CHIDX_Pos) & RADIO_PUBLISH_END_CHIDX_Msk) | \
     ((RADIO_PUBLISH_END_EN_Enabled << RADIO_PUBLISH_END_EN_Pos) & RADIO_PUBLISH_END_EN_Msk))
...
#define HAL_SW_SWITCH_GROUP_TASK_ENABLE_PPI_TASK                                                                      \
    (((HAL_SW_SWITCH_GROUP_TASK_ENABLE_PPI << DPPIC_SUBSCRIBE_CHG_EN_CHIDX_Pos) & DPPIC_SUBSCRIBE_CHG_EN_CHIDX_Msk) | \
     ((DPPIC_SUBSCRIBE_CHG_EN_EN_Enabled << DPPIC_SUBSCRIBE_CHG_EN_EN_Pos) & DPPIC_SUBSCRIBE_CHG_EN_EN_Msk))
...
#define HAL_SW_SWITCH_RADIO_ENABLE_PPI_TASK_TX_SET(chan)                           \
    (((chan << RADIO_SUBSCRIBE_TXEN_CHIDX_Pos) & RADIO_SUBSCRIBE_TXEN_CHIDX_Msk) | \
     ((RADIO_SUBSCRIBE_TXEN_EN_Enabled << RADIO_SUBSCRIBE_TXEN_EN_Pos) & RADIO_SUBSCRIBE_TXEN_EN_Msk))
#define HAL_SW_SWITCH_RADIO_ENABLE_PPI_TASK_RX_SET(chan)                           \
    (((chan << RADIO_SUBSCRIBE_RXEN_CHIDX_Pos) & RADIO_SUBSCRIBE_RXEN_CHIDX_Msk) | \
     ((RADIO_SUBSCRIBE_RXEN_EN_Enabled << RADIO_SUBSCRIBE_RXEN_EN_Pos) & RADIO_SUBSCRIBE_RXEN_EN_Msk))
...
#define HAL_SW_SWITCH_TIMER_S8_DISABLE_PPI_REGISTER_EVT \
    NRF_RADIO->PUBLISH_RATEBOOST
#define HAL_SW_SWITCH_TIMER_S8_DISABLE_PPI_EVT                                                                         \
    (((HAL_SW_SWITCH_TIMER_S8_DISABLE_PPI << RADIO_PUBLISH_RATEBOOST_CHIDX_Pos) & RADIO_PUBLISH_RATEBOOST_CHIDX_Msk) | \
     ((RADIO_PUBLISH_RATEBOOST_EN_Enabled << RADIO_PUBLISH_RATEBOOST_EN_Pos) & RADIO_PUBLISH_RATEBOOST_EN_Msk))
...
#define HAL_SW_SWITCH_TIMER_S8_DISABLE_PPI_TASK                                                                        \
    (((HAL_SW_SWITCH_TIMER_S8_DISABLE_PPI << TIMER_SUBSCRIBE_CAPTURE_CHIDX_Pos) & TIMER_SUBSCRIBE_CAPTURE_CHIDX_Msk) | \
     ((TIMER_SUBSCRIBE_CAPTURE_EN_Enabled << TIMER_SUBSCRIBE_CAPTURE_EN_Pos) & TIMER_SUBSCRIBE_CAPTURE_EN_Msk))
