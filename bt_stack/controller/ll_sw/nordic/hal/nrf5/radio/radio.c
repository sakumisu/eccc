...
void radio_pkt_configure(uint8_t bits_len, uint8_t max_len, uint8_t flags)
{
	 ...
	 */
    if (dc) {
        extra |= (RADIO_PCNF0_S1INCL_Include << RADIO_PCNF0_S1INCL_Pos) & RADIO_PCNF0_S1INCL_Msk;
    }
...
void radio_gpio_pa_setup(void)
{
    ...
    NRF_GPIOTE->CONFIG[CONFIG_BT_CTLR_PA_LNA_GPIOTE_CHAN] =
        ...
        (CONFIG_BT_CTLR_GPIO_PA_PIN << GPIOTE_CONFIG_PSEL_Pos) |
...
void radio_gpio_lna_setup(void)
{
    ...
    NRF_GPIOTE->CONFIG[CONFIG_BT_CTLR_PA_LNA_GPIOTE_CHAN] =
        (GPIOTE_CONFIG_MODE_Task << GPIOTE_CONFIG_MODE_Pos) |
        (CONFIG_BT_CTLR_GPIO_LNA_PIN << GPIOTE_CONFIG_PSEL_Pos) |
        (GPIOTE_CONFIG_POLARITY_Toggle << GPIOTE_CONFIG_POLARITY_Pos) |
    ...
    switch (phy) {
        ...
        case PHY_CODED:
            ...
            NRF_CCM->RATEOVERRIDE =
                (CCM_RATEOVERRIDE_RATEOVERRIDE_500Kbps << CCM_RATEOVERRIDE_RATEOVERRIDE_Pos) &
